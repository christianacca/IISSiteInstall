#
# Module manifest for module 'IISSiteInstall'
#
...
GUID = 'c70169e4-cccf-4cf6-ac32-065a20588fd1'
...
RequiredModules = @(
    ...
    @{ModuleName='IISSecurity'; ModuleVersion='1.3.0'; MaximumVersion = '1.999.0';},
...
FunctionsToExport = @('Get-IISAppPoolUsername','Get-IISSiteAclPath','Get-IISSiteBackConnection','Get-IISSiteHierarchyInfo','Get-IISSiteHostsFileEntry','New-IISAppPool','New-IISWebApp','New-IISWebsite','Remove-IISAppPool','Remove-IISSiteBackConnection','Remove-IISSiteHostsFileEntry','Remove-IISWebApp','Remove-IISWebsite','Set-IISAppPoolUser')
